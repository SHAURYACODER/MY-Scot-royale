...
var bird, slingshot,Eslingshot,Ebird;
...
function setup(){
    ...
    archer1 = createSprite(200,150,50,50);
    ...
    pig1 = new Pig(600, 350,5,5);
    pig1.scale = 0.1;

    pig3 = new Pig(600, 220,5,5);
    pig3.scale = 0.1;

    bird = new Bird(200,120);
    Ebird = new Bird(1000,120);

    //log6 = new Log(230,180,80, PI/2);
    slingshot = new SlingShot(bird.body,{x:200, y:120});
    Eslingshot = new SlingShot(Ebird.body,{x:1000, y:120});
}
